...
# List of years 
year_list = [i for i in range(2015, 2020, 1)]
...
app.layout = html.Div(children=[ html.H1('US Domestic Airline Flights Performance',
                                ...
                                html.Div([
                                   ...
                                   # Add next division 
                                   html.Div([
                                       # First division for adding dropdown helper text for choosing year
                                        html.Div(
                                            [
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            tree_fig = px.treemap(tree_data,path=['DestState','Reprting_Airline'], 
                      values='Flights',
                      color='Flights',
